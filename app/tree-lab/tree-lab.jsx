...
const chapters = [
  { number: "01", title: "Ваша личная медицинская команда", description: "Семейный врач, педиатр, медицинская сестра и медицинский менеджер семьи. Команда, которая знает историю вашей семьи и остаётся рядом.", detail: "Постоянный контакт. Общий контекст.", point: .32 },
